 ...
 <div class="page-wrapper">
            ...
            <div class="container-fluid">
             <button type="button" class="btn btn-primary"><a style="color: #fff" href="<c:url value="/home_admin/product_list" />">Danh sách sản phẩm</a></button>
              <%-- <a href="<c:url value="/home_admin/product_list" />" >Danh sách sản phẩm</a><br /> --%>
  <h1>Thêm sản phẩm mới:</h1>
  <c:url value="/home_admin/saveProduct" var="saveProduct"/>
  <form:form action="${saveProduct}" method="POST" modelAttribute="product">
      Tên sản phẩm: <form:input type="text" path="name_product" name="name_product" /> <br/> 
