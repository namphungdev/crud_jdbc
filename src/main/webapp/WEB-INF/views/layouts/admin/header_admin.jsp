                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<c:url value="/assets/admin/images/logo-icon.png"/>" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="<c:url value="/assets/admin/images/logo-text.png"/>" alt="homepage" class="light-logo" />
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<c:url value="/assets/admin/images/users/1.jpg"/>" alt="user" class="rounded-circle" width="31">
                            </a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        <!-- <li class="sidebar-item active"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/AppleShop/home_admin/" aria-expanded="false"><i class="mdi mdi-view-dashboard "></i><span
                                    class="hide-menu">Trang chủ</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/AppleShop/home_admin/bills_list" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span
                                    class="hide-menu">Đơn hàng</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/AppleShop/home_admin/size_list" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span
                                    class="hide-menu">Kích thước</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/AppleShop/home_admin/category_list" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span
                                    class="hide-menu">Loại sản phẩm</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="/AppleShop/home_admin/product_list" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span
                                    class="hide-menu">Sản phẩm</span></a></li> -->
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-effect sidebar-link"
                                href="/AppleShop/home_admin/capacity_list" aria-expanded="false"><i class="mdi mdi-receipt"></i><span
                                    class="hide-menu">Dung lượng </span></a>
