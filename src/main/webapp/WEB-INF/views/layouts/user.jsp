		...
		<div class="topNav">
			<div class="container">
				<div class="alignR">
					...
					<a class="active " href="/AppleShop"> <span class="icon-home "></span>
						Trang chủ
					</a>
					...
					<c:if test="${ empty LoginInfo}">
						<a href="<c:url value="/dang-ky"/>"><span class="icon-edit"></span>
						 ...
						 <a href="mailto: namthanh2082001@gmail.com"><span class="icon-envelope"></span>
						Liên hệ</a> <a href="<c:url value="/gio-hang"/>"><span
						class="icon-shopping-cart"></span> ${TotalQuantyCart} Sản phẩm - <span
						class="badge badge-warning"></span> <fmt:formatNumber type="number" groupingUsed="true" value="${TotalPriceCart}" /> ₫</a>
				</div>
			</div>
		</div>
	</div>
